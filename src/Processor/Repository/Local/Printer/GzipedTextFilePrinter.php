...
/**
 * Printer class used for creates `GzipedTextFile` instances
 *
 * @package Jigius\Step\Processor\Repository\Local\Printer
 */
final class GzipedTextFilePrinter implements EntityPrinterInterface
{
    /**
     ...
     * for creating `GzipedTextFile` instances
     *
     * @param string $mode The default mode of opened file
     */
    public function __construct(string $mode = "wb9")
    {
        $this->mode = $mode;
    }
    ...
    public function create(): EntityInterface
    {
        ...
        return new Local\Entity\GzipedTextFileEntity($this->pathfile, $this->mode);
    }

    /**
     * Bluprints the current instance of object
     *
     * @return GzipedTextFilePrinter returns bluprinted instance of object
     */
