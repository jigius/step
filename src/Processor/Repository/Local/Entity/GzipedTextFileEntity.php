 ...
 * represents a gziped text file into Local File System
 *
 * @package Jigius\Step\Processors\Repository\Local\Entity
 */
final class GzipedTextFileEntity implements EntityInterface
{
    /**
     ...
     * a gziped text file into Local File System
     *
     * @param string $pathfile The full path to a file
     * @param string $mode The mode of opened file
     */
    public function __construct(string $pathfile, string $mode = "wb9")
    {
    ...
    public function opened(): EntityInterface
    {
        ...
        if (($obj->fd = gzopen($this->pathfile, $this->mode)) === false) {
     ...
     *
     * @return GzipedTextFile Returns bluprinted instance of object
     */
